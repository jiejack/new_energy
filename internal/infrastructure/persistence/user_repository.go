...
func (r *OperationLogRepository) List(ctx context.Context, userID *string, action *string, startTime, endTime int64, page, pageSize int) ([]*entity.OperationLog, int64, error) {
...
func (r *OperationLogRepository) GetByUserID(ctx context.Context, userID string, page, pageSize int) ([]*entity.OperationLog, int64, error) {
	var logs []*entity.OperationLog
	var total int64

	query := r.db.WithContext(ctx).Model(&entity.OperationLog{}).Where("user_id = ?", userID)
